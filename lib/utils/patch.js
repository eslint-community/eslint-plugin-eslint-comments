    ...
    for (const Linter of getLinters()) {
        ...
        Object.defineProperty(Linter.prototype, "_verifyWithoutProcessors", {
            value: function _verifyWithoutProcessors(
                ...
                const severity = getSeverity(providedConfig, ruleId)
                if (severity === 0) {
                    return verify0.call(
                        this,
                        textOrSourceCode,
        ...
        Object.defineProperty(
            ...
            "_verifyWithFlatConfigArrayAndWithoutProcessors",
            {
                value: function _verifyWithFlatConfigArrayAndWithoutProcessors(
                    ...
                    const severity = getSeverity(providedConfig, ruleId)
                    if (severity === 0) {
                        return verifyWithFlatConfig0.call(
                            this,
                            textOrSourceCode,
                            providedConfig,
                            providedOptions
                    ...
                    if (typeof reportUnusedDisableDirectives === "boolean") {
                        reportUnusedDisableDirectives =
                            reportUnusedDisableDirectives ? "error" : "off"
                    }
                    ...
                    const messages = verifyWithFlatConfig0.call(
                        this,
                        textOrSourceCode,
                        config,
                        Object.assign({}, providedOptions, {
                            reportUnusedDisableDirectives: true,
                        })
                    )
                    return convert(
