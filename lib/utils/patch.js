...
module.exports = (
    ...
    for (const Linter of getLinters()) {
        ...
        // Patch _verifyWithFlatConfigArrayAndWithoutProcessors for ESLint 9 (flat config)
        const verifyFlat =
            ...
            Object.defineProperty(
                ...
                "_verifyWithFlatConfigArrayAndWithoutProcessors",
                {
                    value: function _verifyWithFlatConfigArrayAndWithoutProcessors(
                        ...
                        const linterOptsValue = configArray.linterOptions?.reportUnusedDisableDirectives
                        const reportUnusedDisableDirectives =
                            opts.reportUnusedDisableDirectives !== undefined ||
                            (linterOptsValue === 2 || linterOptsValue === "error")
                        ...
                        if (originalLinterOptions) {
                            modifiedConfigArray.linterOptions = originalLinterOptions
                        }
